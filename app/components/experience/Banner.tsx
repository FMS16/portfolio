...
const Banner = () => {
  return (
    <div className='background-experience h-[100vh] flex relative justify-center items-center'>
      <h1 className="text-9xl w-[90%] dark:text-[#000] xl:w-full text-center mx-auto sf-bold max-sm:text-6xl">Where I have been</h1>
      <button
